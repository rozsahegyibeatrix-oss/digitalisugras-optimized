  ...
  hu: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Kinek szól a szolgáltatás?", a: "Magyar kisvállalkozásoknak: manikűr szalonoknak, pékségeknek, borbélyoknak és üzleteknek." },
        { q: "Mit tartalmaz az indító csomag?", a: "Kész, foglalós weboldalt 7 nap alatt és indításra kész hirdetési csomagot. Egyszeri díj: 89 000 Ft az első 50 ügyfélnek, 149 000 Ft helyett." },
        { q: "Mit kell nekem csinálnom?", a: "Három kérdésre válaszolsz: mit csinálsz és hol, mi a legnagyobb marketing problémád, és hogyan érünk el a leggyorsabban. Utána mi készítjük a weboldalt, a hirdetéseket és a tartalmat — te csak jóváhagyod." },
        { q: "Ki ellenőrzi az MI által készített munkát?", a: "Az MI felgyorsítja a munkát, de minden eredményt egy ember ellenőriz és hagy jóvá, mielőtt kikerül." },
        { q: "Mennyi tartalmat kapok havonta?", a: "A Basic csomagban havi 4 posztot, a Standardben 8-at, a Proban 12-t." },
        { q: "Van rejtett költség vagy kötelező szerződés?", a: "Nincs. Az árak fixek, rejtett költség nincs, az indítás után pedig nincs kötelező havi szerződés." },
      ],
    },
    lead: {
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Who is the service for?", a: "Hungarian small businesses: nail salons, bakeries, barbershops and shops." },
        { q: "What does the launch package include?", a: "A booking-ready website in 7 days and a launch-ready ad package. One-time fee: 89,000 Ft for the first 50 clients, instead of 149,000 Ft." },
        { q: "What do I have to do?", a: "You answer three questions: what you do and where, your biggest marketing pain, and how we can reach you fastest. Then we build the website, the ads and the content — you just approve." },
        { q: "Who checks the work the AI produces?", a: "AI speeds up the work, but a human reviews and approves every result before it goes out." },
        { q: "How much content do I get each month?", a: "4 posts a month on Basic, 8 on Standard and 12 on Pro." },
        { q: "Are there hidden costs or a required contract?", a: "No. Prices are fixed, there are no hidden costs, and there is no required monthly contract after launch." },
      ],
    },
    lead: {
